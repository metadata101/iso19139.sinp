...
package org.fao.geonet.schema.iso19139.sinp;
 ...
 */
public class ISO19139SinpSchemaPlugin
    ...
    ExportablePlugin,
    ISOPlugin {
    public static final String IDENTIFIER = "iso19139.sinp";
    ...
    static {
        allNamespaces = ImmutableSet.<Namespace>builder()
            ...
            .add(ISO19139SinpNamespaces.SINP)
        ...
        allTypenames = ImmutableMap.<String, Namespace>builder()
            ...
            .put("sinp:MD_Metadata", ISO19139SinpNamespaces.SINP)
    ...
    public ISO19139SinpSchemaPlugin() {
